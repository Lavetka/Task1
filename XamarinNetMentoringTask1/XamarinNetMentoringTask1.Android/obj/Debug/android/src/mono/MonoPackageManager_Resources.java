...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinNetMentoringTask1.Android.dll" comes first in this list. */
		"XamarinNetMentoringTask1.Android.dll",
		"CustomLibraryTask1.dll",
		"FormsViewGroup.dll",
